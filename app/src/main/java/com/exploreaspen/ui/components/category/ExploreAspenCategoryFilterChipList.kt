...
@Composable
fun ExploreAspenCategoryFilterChipList(
...
@Preview
@Composable
private fun ExploreAspenCategoryFilterChipListPreview() {
    ExploreAspenCategoryFilterChipList(categories = mockCategories, onSelectedCategoryChanged = {})
}